...
const API_KEY = import.meta.env.VITE_OLD_GEMINI_API_KEY;
...
export const getHealthResponse = async (userMessage, language = 'en') => {
    try {
        ...
        const systemPrompts = {
            ...
            mr: "तुम्ही एक मैत्रीपूर्ण आरोग्य सहाय्यक आहात. उपयुक्त, अचूक आरोग्य माहिती द्या. गंभीर चिंतांसाठी नेहमी वापरकर्त्यांना व्यावसायिक वैद्यकीय मदत घेण्याची आठवण करून द्या. प्रतिसाद संक्षिप्त आणि स्पष्ट ठेवा. मराठीत उत्तर द्या।",
